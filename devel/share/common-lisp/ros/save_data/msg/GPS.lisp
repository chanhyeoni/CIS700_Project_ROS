...
(cl:defmethod cl:initialize-instance :after ((m <GPS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GPS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name save_data-msg:<GPS> is deprecated: use save_data-msg:GPS instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <GPS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader save_data-msg:latitude-val is deprecated.  Use save_data-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <GPS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader save_data-msg:longitude-val is deprecated.  Use save_data-msg:longitude instead.")
  (longitude m))
